  ...
  return (
    <PageWrapper>
      <div className="flex flex-col items-center justify-center min-h-screen text-white px-6">
        <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl rounded-2xl p-8 text-center">
          ...
          <form onSubmit={handleSignup} className="flex flex-col space-y-5">
            ...
            <button type="submit" disabled={loading} className="py-3 rounded-lg bg-gradient-to-r from-cyan-500 via-pink-500 to-orange-400">
