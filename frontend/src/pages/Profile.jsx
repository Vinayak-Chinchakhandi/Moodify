...
const Profile = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[radial-gradient(circle_at_center,#0a0a1a,#000)] text-white overflow-hidden">
      {/* 🌌 Particle Background */}
      ...
      <div className="relative z-10 w-full max-w-2xl glass-card text-center p-10 backdrop-blur-2xl border border-white/10 rounded-2xl">
        ...
        {!editing ? (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-cyan-300 mt-4">🎧 Language Preferences</h3>
