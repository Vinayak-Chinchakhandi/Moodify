...
const Login = () => {
  ...
  return (
    <PageWrapper>
      <div className="relative flex flex-col items-center justify-center min-h-screen text-white px-4 sm:px-6 py-6">
        <div className="
relative z-10
w-full
max-w-sm
...
">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-3 sm:mb-4 gradient-text">Welcome Back 🎵</h2>
...
" />
            ...
            <button type="button" onClick={handleForgotPassword} className="text-cyan-400 hover:text-pink-400 text-xs sm:text-sm">
              Forgot Password?
            </button>
...
"          >
          ...
          <p className="mt-4 sm:mt-6 text-sm text-gray-400">            Don’t have an account?{" "}
